...
namespace Com.Facebook.Common.Executors
{
	...
	public partial interface IHandlerExecutorService : global::Java.Util.Concurrent.IScheduledExecutorService
	{
		...
		bool IsHandlerThread
		{
			...
			[Register("isHandlerThread", "()Z", "GetIsHandlerThreadHandler:Com.Facebook.Common.Executors.IHandlerExecutorServiceInvoker, FBCore")]
			get;
		}
		...
		[Register("quit", "()V", "GetQuitHandler:Com.Facebook.Common.Executors.IHandlerExecutorServiceInvoker, FBCore")]
		void Quit();
...
#pragma warning restore 0169
		...
		IList<IRunnable> ShutdownNow()
		{
			...
			global::System.Collections.IList __ret = JavaList.FromJniHandle(JNIEnv.CallObjectMethod(((global::Java.Lang.Object)this).Handle, id_shutdownNow), JniHandleOwnership.TransferLocalRef);
			return (IList<IRunnable>)__ret;
		}
		...
		//	if (id_shutdownNow == IntPtr.Zero)
		//		id_shutdownNow = JNIEnv.GetMethodID(class_ref, "shutdownNow", "()Ljava/util/List;");
		//	return global::Android.Runtime.JavaList.FromJniHandle(JNIEnv.CallObjectMethod(((global::Java.Lang.Object)this).Handle, id_shutdownNow), JniHandleOwnership.TransferLocalRef);
		//}
